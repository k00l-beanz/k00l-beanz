    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        while (true) {
            ...
            if (iArr2[i11] < MotionPaths.names.length) {
                String concat = String.valueOf(MotionPaths.names[this.mInterpolateVariables[i11]]).concat(" [");
                for (int i12 = 0; i12 < size; i12++) {
                    String valueOf2 = String.valueOf(concat);
                    double d = dArr[i12][i11];
        ...
        while (true) {
            ...
            double[][] dArr4 = null;
            while (i14 < size) {
                if (motionPathsArr[i14].hasCustomData(str7)) {
                    if (dArr4 == null) {
                        dArr3 = new double[size];
                        int[] iArr3 = new int[i];
                        iArr3[1] = motionPathsArr[i14].getCustomDataCount(str7);
                        iArr3[c] = size;
                        dArr4 = (double[][]) Array.newInstance(double.class, iArr3);
                    }
                    dArr3[i15] = motionPathsArr[i14].time;
                    motionPathsArr[i14].getCustomData(str7, dArr4[i15], 0);
                    i15++;
                }
                i14++;
                i = 2;
