    ...
    */
    ...
    public class Model {
        ...
        private void debugWidget(String str, ConstraintWidget child) {
            ...
            if (child.mTop.mTarget != null) {
                String str6 = child.mTop.mTarget.mType == ConstraintAnchor.Type.TOP ? "T" : "B";
            ...
            if (child.mBottom.mTarget != null) {
                String str7 = child.mBottom.mTarget.mType != ConstraintAnchor.Type.TOP ? "B" : "T";
            ...
            if (child.mLeft.mTarget != null) {
                String str8 = child.mLeft.mTarget.mType == ConstraintAnchor.Type.LEFT ? "L" : "R";
            ...
            if (child.mRight.mTarget != null) {
                String str9 = child.mRight.mTarget.mType != ConstraintAnchor.Type.LEFT ? "R" : "L";
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String str = constraintWidget.mTop.mTarget != null ? "T" : "_";
    ...
    private class DevModeDraw {
        ...
        private void drawPathCartesianTicks(Canvas canvas, float x, float y) {
            ...
            StringBuilder sb = new StringBuilder(15);
            sb.append(((int) (((min2 * 100.0f) / Math.abs(f3 - f)) + 0.5d)) / 100.0f);
            String sb2 = sb.toString();
            getTextBounds(sb2, this.mTextPaint);
            ...
            sb3.append(((int) (((max2 * 100.0f) / Math.abs(f4 - f2)) + 0.5d)) / 100.0f);
    ...
    */
    ...
    private void checkStructure(int csetId, ConstraintSet set) {
        ...
        for (int i2 = 0; i2 < knownIds.length; i2++) {
            int i3 = knownIds[i2];
            String name4 = Debug.getName(getContext(), i3);
