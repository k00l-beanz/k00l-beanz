...
[/home/Default/Documents/Repos/cerberus-bytes/Cerberus-bytes/HacktheBox/machines/hard/reel/results/10.10.10.77/scans/_full_tcp_nmap.txt](file:///home/Default/Documents/Repos/cerberus-bytes/Cerberus-bytes/HacktheBox/machines/hard/reel/results/10.10.10.77/scans/_full_tcp_nmap.txt):

```
# Nmap 7.92 scan initiated Fri Oct 21 00:06:51 2022 as: nmap -vv --reason -Pn -T4 -sV -sC --version-all -A --osscan-guess -p- -oN /home/Default/Documents/Repos/cerberus-bytes/Cerberus-bytes/HacktheBox/machines/hard/reel/results/10.10.10.77/scans/_full_tcp_nmap.txt -oX /home/Default/Documents/Repos/cerberus-bytes/Cerberus-bytes/HacktheBox/machines/hard/reel/results/10.10.10.77/scans/xml/_full_tcp_nmap.xml 10.10.10.77
Nmap scan report for 10.10.10.77
Host is up, received user-set (0.014s latency).
Scanned at 2022-10-21 00:06:51 EDT for 653s
...
SF-Port25-TCP:V=7.92%I=9%D=10/21%Time=63521B5D%P=x86_64-pc-linux-gnu%r(NUL
...
Aggressive OS guesses: Microsoft Windows Server 2012 or Windows Server 2012 R2 (91%), Microsoft Windows Server 2012 (90%), Microsoft Windows Server 2012 R2 (90%), Microsoft Windows 7 (85%), Microsoft Windows Vista SP0 or SP1, Windows Server 2008 SP1, or Windows 7 (85%)
No exact OS matches for host (test conditions non-ideal).
TCP/IP fingerprint:
SCAN(V=7.92%E=4%D=10/21%OT=21%CT=%CU=%PV=Y%DS=2%DC=T%G=N%TM=63521D68%P=x86_64-pc-linux-gnu)
SEQ(SP=FC%GCD=1%ISR=100%TI=I%II=I%SS=S%TS=7)
...
Uptime guess: 0.008 days (since Fri Oct 21 00:05:40 2022)
...
HOP RTT      ADDRESS
1   12.65 ms 10.10.14.1
2   14.20 ms 10.10.10.77

Read data files from: /usr/bin/../share/nmap
OS and Service detection performed. Please report any incorrect results at https://nmap.org/submit/ .
# Nmap done at Fri Oct 21 00:17:44 2022 -- 1 IP address (1 host up) scanned in 653.36 seconds
